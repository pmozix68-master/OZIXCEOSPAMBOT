RAID = [
    ...
    "JHULA JHUL MAGAR OZIX PAPA KO MTT BHUL",
    "OZIX PAPA TERI MAA KO RANDI BANA KE PELENGE",
    "TERI RANDI MAA KO OZIX PAPA KUTAA BANAKE CHODENGE",
]
...
REPLYRAID = [
    ...
    "APNI MAA KO BHEJ OZIX PAPA KE PASS",
    "OZIX PAPA TEREE PURE KHANADAN KE AURTON CHOD DAALENGE EK HI TIME ME",
    "FHATE HUWE CONDOM KE NAJAYAJ AUALAD OZIX KAA NAJAYAJ  BETAA AUAKAT ME REHNAA SIKH LE",
    "TERI MAA KI CHUT ME SUAAR KAA DANT GUSED DEGAA OZIX PAPA",
    "OZIX PAPA SE BAKCHODI MTT KAR BHADWEE",
    "JO KHAAYE BURGER OZIX USKI MAIYAA CHODE GAR GAR",
]
